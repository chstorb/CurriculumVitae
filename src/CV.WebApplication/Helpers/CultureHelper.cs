...
namespace CV.WebApplication.Helpers
{
    /// <summary>
    /// CultureHelper class for ASP.Net MVC Internationalization.
    /// The CultureHelper class helps us to store culture names we are implementing in our site.    
